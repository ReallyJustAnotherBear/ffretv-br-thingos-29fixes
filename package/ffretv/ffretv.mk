...
FFRETV_SITE = https://github.com/kelsieflynn/ffretv/releases
...
FFRETV_CONF_OPTS += --enable-ffretv
else
FFRETV_CONF_OPTS += --disable-ffretv
endif
...
FFRETV_CONF_OPTS += --enable-mmal --enable-omx --enable-omx-rpi \
...
FFRETV_CONF_OPTS += --enable-x86asm
FFRETV_DEPENDENCIES += host-nasm
else
FFRETV_CONF_OPTS += --disable-x86asm
FFRETV_CONF_OPTS += --disable-mmx
endif

ifeq ($(BR2_X86_CPU_HAS_SSE),y)
FFRETV_CONF_OPTS += --enable-sse
else
FFRETV_CONF_OPTS += --disable-sse
endif

ifeq ($(BR2_X86_CPU_HAS_SSE2),y)
FFRETV_CONF_OPTS += --enable-sse2
else
FFRETV_CONF_OPTS += --disable-sse2
endif

ifeq ($(BR2_X86_CPU_HAS_SSE3),y)
FFRETV_CONF_OPTS += --enable-sse3
else
FFRETV_CONF_OPTS += --disable-sse3
endif

ifeq ($(BR2_X86_CPU_HAS_SSSE3),y)
FFRETV_CONF_OPTS += --enable-ssse3
else
FFRETV_CONF_OPTS += --disable-ssse3
endif

ifeq ($(BR2_X86_CPU_HAS_SSE4),y)
FFRETV_CONF_OPTS += --enable-sse4
else
FFRETV_CONF_OPTS += --disable-sse4
endif

ifeq ($(BR2_X86_CPU_HAS_SSE42),y)
FFRETV_CONF_OPTS += --enable-sse42
else
FFRETV_CONF_OPTS += --disable-sse42
endif

ifeq ($(BR2_X86_CPU_HAS_AVX),y)
FFRETV_CONF_OPTS += --enable-avx
else
FFRETV_CONF_OPTS += --disable-avx
endif

ifeq ($(BR2_X86_CPU_HAS_AVX2),y)
FFRETV_CONF_OPTS += --enable-avx2
else
FFRETV_CONF_OPTS += --disable-avx2
endif
...
FFRETV_CONF_OPTS += --disable-mipsfpu
else
FFRETV_CONF_OPTS += --enable-mipsfpu
endif
endif # MIPS

ifeq ($(BR2_POWERPC_CPU_HAS_ALTIVEC),y)
FFRETV_CONF_OPTS += --enable-altivec
else
FFRETV_CONF_OPTS += --disable-altivec
endif

# Uses __atomic_fetch_add_4
ifeq ($(BR2_TOOLCHAIN_HAS_LIBATOMIC),y)
FFRETV_CONF_OPTS += --extra-libs=-latomic
endif
...
# warning from ffretv's configure script.
ifeq ($(BR2_mips)$(BR2_mipsel)$(BR2_mips64)$(BR2_mips64el),y)
FFRETV_CONF_OPTS += --cpu=generic
else ifneq ($(call qstrip,$(BR2_GCC_TARGET_CPU)),)
FFRETV_CONF_OPTS += --cpu=$(BR2_GCC_TARGET_CPU)
else ifneq ($(call qstrip,$(BR2_GCC_TARGET_ARCH)),)
FFRETV_CONF_OPTS += --cpu=$(BR2_GCC_TARGET_ARCH)
endif
