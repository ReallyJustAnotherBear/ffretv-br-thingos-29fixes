...
*You can try 3 too , but it has debug enabled, so the mkrelease may fail unless you increase rootfs size, else disabled DEBUG in menuconfig first for the rpi3.
